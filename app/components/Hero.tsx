    ...
    <section className="hero">
      ...
      <div className="hero-content">
        ...
        <p className="hero-sub">
          Women-only group classes in a warm, private studio in Beit Shemesh.
          Strength training, cardio, dance — real work that leaves you stronger
          every time. Come exactly as you are.
        </p>
